"""
    ...
    note: changed "." functions to outside of loops 
    changed a**b to pow(a,b) in compute_mag,compute_energy
    reduced duplicate function calls in update_vs
...
#     return dt * pow(dx * dx + dy * dy + dz * dz , -1.5)
